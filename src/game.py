...
BACKGROUND_PATH = 'sprites/background.jpg'
GAMEOVER_SOUND_PATH = 'sounds/gameover.wav'
EXPLOSION_SOUND_PATH = 'sounds/explosion.wav'
THEME_SOUND_PATH = 'sounds/theme.mp3'
...
class Game():
    def __init__(self):
        ...
        self.background = pygame.transform.scale(pygame.image.load(BACKGROUND_PATH), (self.WIDTH, self.HEIGHT))
    ...
    def run(self):
        ...
        while not game_over:
            ...
            if game_over:
                ...
                self.canvas.blit(game_over_text, \
